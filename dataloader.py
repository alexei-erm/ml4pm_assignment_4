...
import numpy as np
from plot_utils import set_seed
...
def prepare_data(batch_size=128, seed=42):
    # Get seed worker and generator
    seed_worker, generator = set_seed(seed)
    ...
    # Create dataloaders with seed worker and generator
